...
st.write('This is a demo of a video learning platform that uses AI to generate questions and provide feedback on user answers. Enter a YouTube video URL and the current playback time to get started.')
